...
class Client {
    ...
    getAvailableRooms(roomName = "") {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            return (yield this.http.get(`matchmake/${roomName}`, Object.assign(Object.assign({}, (this.httpOptions || {})), { headers: Object.assign(Object.assign({}, (((_a = this.httpOptions) === null || _a === void 0 ? void 0 : _a.headers) || {})), { 'Accept': 'application/json' }) }))).data;
        });
    }
    ...
    createMatchMakeRequest(method, roomName, options = {}, rootSchema, reuseRoomInstance) {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            const response = (yield this.http.post(`matchmake/${method}/${roomName}`, Object.assign(Object.assign({}, (this.httpOptions || {})), { headers: Object.assign(Object.assign({}, (((_a = this.httpOptions) === null || _a === void 0 ? void 0 : _a.headers) || {})), { 'Accept': 'application/json', 'Content-Type': 'application/json' }), body: JSON.stringify(options) }))).data;
    ...
    createRoom(roomName, rootSchema) {
        return new Room_1.Room(roomName, rootSchema, this.httpOptions);
    }
